...
public class CalculatorForm : Form
{
    ...
    public void InitializeButtonOne()
    {
        ...
        InitializeCommonNumberProperties(buttonOne);
    ...
    public void InitializeButtonTwo()
    {
        ...
        InitializeCommonNumberProperties(buttonTwo);
    ...
    public void InitializeButtonThree()
    {
        ...
        InitializeCommonNumberProperties(buttonThree);
    ...
    public void InitializeButtonFour()
    {
        ...
        InitializeCommonNumberProperties(buttonFour);
    ...
    public void InitializeButtonFive()
    {
        ...
        InitializeCommonNumberProperties(buttonFive);
    ...
    public void InitializeButtonSix()
    {
        ...
        InitializeCommonNumberProperties(buttonSix);
    ...
    public void InitializeButtonSeven()
    {
        ...
        InitializeCommonNumberProperties(buttonSeven);
    ...
    public void InitializeButtonEight()
    {
        ...
        InitializeCommonNumberProperties(buttonEight);
    ...
    public void InitializeButtonNine()
    {
        ...
        InitializeCommonNumberProperties(buttonNine);
    ...
    public void InitializeButtonZero()
    {
        ...
        InitializeCommonNumberProperties(buttonZero);
    ...
    public void InitializeButtonDot()
    {
        ...
        InitializeCommonNumberProperties(buttonDot);
    ...
    public void InitializeCommonNumberProperties(Button button)
    {
    ...
    public void InitializeButtonPlus()
    {
        ...
        InitializeCommonOperationProperties(buttonPlus);
    ...
    public void InitializeButtonMinus()
    {
        ...
        InitializeCommonOperationProperties(buttonMinus);
    ...
    public void InitializeButtonAstherics()
    {
        ...
        InitializeCommonOperationProperties(buttonAstherics);
    ...
    public void InitializeButtonSlash()
    {
        ...
        InitializeCommonOperationProperties(buttonSlash);
    ...
    public void InitializeCommonOperationProperties(Button button)
    {
        button.Font = new Font("Segoe UI", 12F);
        button.Size = new Size(72, 76);
        button.UseVisualStyleBackColor = true;
    ...
    private void EqualClick(object sender, EventArgs e)
    {
        ...
        {
            case "+":
                textBoxResult.Text = CalculateSum();
                break;
            case "-":
                textBoxResult.Text = CalculateDifference();
                break;
            case "*":
                textBoxResult.Text = CalculateProduct();
                break;
            case "/":
                textBoxResult.Text = CalculateQuotient();
                break;
            default:
                return;
        }
    ...
    private string CalculateProduct()
    {
        return (resultValue * double.Parse(textBoxResult.Text)).ToString();
    }
    ...
    {
        return textBoxResult.Text == "0"
            ? "Error"
            : (resultValue / double.Parse(textBoxResult.Text)).ToString();
    }
}